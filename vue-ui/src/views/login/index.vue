      ...
      <div class="login-card">
        ...
        <div class="card-content">
          <div class="card-header">
            ...
            <h2 class="card-title">智能Agent 登录</h2>
            <p class="card-subtitle">欢迎回到 WTAPI 智能Agent</p>
          </div>
          ...
          <div class="card-footer">
            ...
            <div class="footer-actions">
              ...
              <el-button type="primary" link class="register-btn" @click="goRegister">
                立即注册
...
const handleLogin = () => {
  loginFormRef.value.validate(async (valid) => {
    ...
    try {
      ...
      userStore.setUserInfo(res.data.token, loginForm.username)
